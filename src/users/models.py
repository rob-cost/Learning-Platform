...
class LearningProfile(models.Model):
    ...
    difficulty_level = models.CharField(
        max_length=13, choices=DIFFICULTY_CHOICES, default="beginner"
    )
    ...
    learning_pace = models.FloatField(
        default=0.0, help_text="Lessons completed per week"
    )
...
class DifficultyQuestions(models.Model):
    subject = models.CharField(
        max_length=50, choices=SUBJECT_CHOICES, help_text="topic's subject"
    )
